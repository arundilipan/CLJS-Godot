export default class REPL extends godot.Node {
	constructor() {
		super();
		this.wsURL = "ws://127.0.0.1:9630";
	}
	_ready() {
		this.wsClient = new godot.WebSocketClient();
		this.wsClient.connect(godot.WebSocketClient.connection_closed, (wasClean) => {
		...
		this.wsClient.connect(godot.WebSocketClient.connection_established, (proto) => {
			console.log("Connected with protocol: ", proto);
			this.wsClient.get_peer(1).put_var("Connected");
		});
		this.wsClient.connect(godot.WebSocketClient.data_received, () => {
