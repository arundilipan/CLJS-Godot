...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26577 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26577(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26579 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26579(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26587 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26587(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26592 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26592(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26598 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26598(reader);
}
});
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26603(reader);
}
});
...
var G__26720 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26721 = s.append(c);
c = G__26720;
s = G__26721;
continue;
}
